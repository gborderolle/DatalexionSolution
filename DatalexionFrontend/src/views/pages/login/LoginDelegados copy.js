          ...
          <CCol md={8}>
            <CCardGroup>
              ...
              <CCard className={`bg ${classes.loginRight}`}>
                ...
                >
                  <CCard className={`p-3 text-white bg-dark py-5`}>
                    <CCardBody className="text-center">
                      ...
                      <div>
                        ...
                        <p className={classes.p}>
                          Datalexion es un dashboard analítico para optimizar y
                          procesar la información en tiempo real. Datalexion es
                          el aliado tecnológico ideal para la gestión electoral
                          eficiente.
                        </p>
                      </div>
                    </CCardBody>
